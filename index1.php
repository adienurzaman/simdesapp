            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li><a data-toggle="tab" href="#Profil"><i class="notika-icon notika-mail"></i>Profil</a>
                        </li>
                        <li><a data-toggle="tab" href="#Interface"><i class="notika-icon notika-edit"></i>Kesehatan</a>
                        </li>
                        <li><a data-toggle="tab" href="#Charts"><i class="notika-icon notika-bar-chart"></i>Keamanan</a>
                        </li>
                        <li><a data-toggle="tab" href="#Tables"><i class="notika-icon notika-windows"></i>Siaga bencana</a>
                        </li>
                        <li><a data-toggle="tab" href="#login"><i class="notika-icon notika-form"></i>Login</a>
                        </li>
                    </ul>
                    <div class="tab-content custom-menu-content">
                        ...
                        <div id="Profil" class="tab-pane notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                <li><a href="inbox.html">Tentang Desa</a>
                                </li>
                                <li><a href="view-email.html">Struktural</a>
                            </ul>
                        </div>
                        ...
                        <div id="login" class="tab-pane notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                <li><a href="index_login.php">Signin</a>
                                </li>
                                <li><a href="form-components.html">Sigup</a>
                                </li>
                            </ul>
                        </div>
                    </div>
